/*******************************************************************
	*   CS 121 Programming Assignment 4:6
	...
	while(!bQuitGame)
	{
		...
		if (cmdVerb == "GO")
		{
			...
			if(cmdObj == "NORTH")
			{
				...
				{
					iRow--;//Move up a row
					DescribeRoomContents(roomTest,iRow,iCol);
				}
			}
...
void DescribeRoomContents(int roomDesc, int row, int col)
{
	...
	if(roomDesc & Dwarves)
	{
		cout <<"An angry dwarf is shouting at you..."<<endl;
	}

	//check conditions
	if(roomDesc & DEADLY)
	{
		cout << "This creature is deadly..." << endl;
	}
	if(roomDesc & DANGEROUS)
	{
		cout << "This creature is dangerous..." << endl;
	}
	if(roomDesc & CAUTION)
	{
	...
	{
		cout <<"there is something dark glinting in the water..."<<endl;
	}
	if(roomDesc & A_Pint_From_The_Green_Dragon)
	{
		cout <<"You can get a pint of the finest ale here..."<<endl;
	}
	if(roomDesc & Elven_Harp)
	{
		cout <<"there is an elven harp playing music to your right..."<<endl;
	}
	if(roomDesc & Narya)
	{
	...
	{
		cout <<"You can get a leg of salted pork here..."<<endl;
	}
	if(roomDesc & Shield)
	{
	...
	{
		cout <<"You see an old boot on the ground..."<<endl;
	}

	//check for treasure items
	if(roomDesc & First_Shard_of_Narsil)
	{
		cout <<"A shard of Narsil's blade is laying on the floor..."<<endl;
	}
	if(roomDesc & Second_Shard_of_Narsil)
	{
		cout <<"The binding stone of Narsil is on the floor..."<<endl;
	}
	if(roomDesc & Third_Shard_of_Narsil)
	{
		cout <<"The main blade of Narsil lays ahead..."<<endl;
	}
	if(roomDesc & Fourth_Shard_of_Narsil)
	{
		cout <<"The tip of Narsil lays ahead..."<<endl;
	}
